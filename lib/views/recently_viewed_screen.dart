...
class _RecentlyViewedScreenState extends State<RecentlyViewedScreen> {
          ...
          slivers: [
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Selector<UserViewedProfileProvider, int>(
                ...
                return ProfileInfoListTile(
                  onTap: () => NavRoutes.navToProductDetails(
                    ...
                    arguments: ProfileDetailArguments(
                        index: index,
                        navToProfile: NavToProfile.navFromRecentlyViewed),
                  ),
            ...
            SliverToBoxAdapter(
                child: Selector<UserViewedProfileProvider, bool>(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CommonAppBar(
        ...
        pageTitle: context.loc.recentlyViewed,
      ),
      body: Selector<UserViewedProfileProvider,
  ...
  void scrollListener() {
    if (scrollController.offset >=
      ...
      context.read<UserViewedProfileProvider>().onLoadMore();
    }
  }

  Future<void> _fetchData({bool clearData = true}) async {
    clearData
        ? context.read<UserViewedProfileProvider>().pageInit()
        : context.read<UserViewedProfileProvider>().initPageCount();
    context.read<UserViewedProfileProvider>().getNewProfileViewedData();
  }
