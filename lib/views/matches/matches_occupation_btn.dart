...
class MatchesOccupationBtn extends StatefulWidget {
  const MatchesOccupationBtn({Key? key}) : super(key: key);

  @override
  State<MatchesOccupationBtn> createState() => _FilterOccupationBtnState();
}

class _FilterOccupationBtnState extends State<MatchesOccupationBtn> {
  late final TextEditingController textEditingController;

  Widget _searchListView(Map<int, JobData?> selectedJObs) {
    return Selector<MatchesProvider, List<JobData>>(
        ...
        builder: (context, value, child) {
          ...
          return BottomResView(
              ...
              child: FilterBottomSheetContainer(
                ...
                onClearTap: () {
                  context.read<MatchesProvider>().clearOccupationFilterData();
                },
                child: Expanded(
                  child: Selector<MatchesProvider, Map<int, JobData?>>(
                    selector: (context, provider) =>
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Selector<MatchesProvider, Map<int, JobData?>>(
        selector: (context, provider) =>
      ...
      Selector<MatchesProvider, Map<int, JobData?>>(
        ...
        selector: (p0, p1) =>
            p1.searchFilterValueModel?.selectedOccupations ?? {},
