...
class NearByMatchesScreen extends StatefulWidget {
  const NearByMatchesScreen({Key? key}) : super(key: key);

  @override
  State<NearByMatchesScreen> createState() => _NearByMatchesScreenState();
}

class _NearByMatchesScreenState extends State<NearByMatchesScreen> {
  @override
        ...
        return StackLoader(
          ...
          child: _switchView(
              ...
              matchesProvider.selectedChildIndex == 0
                  ? matchesProvider.nearByMatchesNotViewedUserDataList
                  : matchesProvider.nearByMatchesViewedUserDataList),
        );
      },
    );
  }
  ...
  _mainView(MatchesProvider matchesProvider, List<UserData> userDataList) {
          ...
          slivers: [
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Text(
                  context.loc.members(matchesProvider.selectedChildIndex == 0
                      ? matchesProvider.nearByProfilesNotViewedRecords
                      : matchesProvider.nearByProfilesViewedRecords),
            ...
            ReusableWidgets.sliverPaginationLoader(
                matchesProvider.paginationLoader)
          ],
        ),
      ),
    );
