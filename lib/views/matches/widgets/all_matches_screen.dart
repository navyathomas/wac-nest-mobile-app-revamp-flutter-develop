    ...
    controller = ScrollController()
      ..addListener(() {
        if (controller.offset >= (controller.position.maxScrollExtent * 0.5)) {
          if (!context.isNull) {
            context.read<MatchesProvider>().loadMoreSwitch(context);
          }
        }
      });
    super.initState();
        ...
        return StackLoader(
            ...
            child: _switchView(
                ...
                matchesProvider.selectedChildIndex == 0
                    ? matchesProvider.allMatchesNotViewedUserDataList
                    : matchesProvider.allMatchesViewedUserDataList));
      },
    );
  }
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: Container(
        ...
        child: CustomScrollView(
          ...
          // controller: provider.subScrollController,
              ...
              child: Padding(
                ...
                child: Text(
                  context.loc.members(provider.selectedChildIndex == 0
                      ? provider.allMatchesNotViewRecords
                      : provider.allMatchesViewedRecords),
