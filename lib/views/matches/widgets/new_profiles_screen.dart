...
class NewProfilesMatchesScreen extends StatefulWidget {
  const NewProfilesMatchesScreen({Key? key}) : super(key: key);

  @override
  State<NewProfilesMatchesScreen> createState() =>
      _NewProfilesMatchesScreenState();
}

class _NewProfilesMatchesScreenState extends State<NewProfilesMatchesScreen> {
  @override
        ...
        return StackLoader(
            ...
            child: _switchView(
                ...
                matchesProvider.selectedChildIndex == 0
                    ? matchesProvider.newProfileMatchesNotViewedUserDataList
                    : matchesProvider.newProfileMatchesViewedUserDataList));
      },
    );
  }
              ...
              child: Padding(
                ...
                child: Text(
                  context.loc.members(provider.selectedChildIndex == 0
                      ? provider.newProfilesNotViewedRecords
                      : provider.newProfilesViewedRecords),
