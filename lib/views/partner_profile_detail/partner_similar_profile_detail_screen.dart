...
class PartnerSimilarProfileDetailScreen extends StatefulWidget {
  final SimilarProfileDetailArguments? similarProfileDetailArguments;

  const PartnerSimilarProfileDetailScreen(
      {Key? key, this.similarProfileDetailArguments})
      : super(key: key);

  @override
  State<PartnerSimilarProfileDetailScreen> createState() =>
      _PartnerSimilarProfileDetailScreenState();
}

class _PartnerSimilarProfileDetailScreenState
    extends State<PartnerSimilarProfileDetailScreen>
  ...
  void _fetchData() {
    context.read<PartnerDetailProvider>()
      ..resetUsers()
      ..resetAlertStat()
      ..updateFromSimilarDetails(
          context: context,
          usersData: widget.similarProfileDetailArguments?.usersData,
          index: widget.similarProfileDetailArguments?.index,
          navFrom: widget.similarProfileDetailArguments?.navToProfile)
