...
class PartnerPreferenceCasteBtn extends StatefulWidget {
  const PartnerPreferenceCasteBtn({Key? key}) : super(key: key);

  @override
  State<PartnerPreferenceCasteBtn> createState() => _FilterCasteBtnState();
}

class _FilterCasteBtnState extends State<PartnerPreferenceCasteBtn> {
