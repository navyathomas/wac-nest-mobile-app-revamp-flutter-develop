...
import 'filter_check_box_tile_partner_preference.dart';

class PartnerPreferenceEducationBtn extends StatefulWidget {
  const PartnerPreferenceEducationBtn({Key? key}) : super(key: key);

  @override
  State<PartnerPreferenceEducationBtn> createState() =>
      _PartnerPreferenceEducationBtnState();
}

class _PartnerPreferenceEducationBtnState
    extends State<PartnerPreferenceEducationBtn> {
                                    ...
                                    itemBuilder: (context, subIndex) {
                                      ...
                                      List<int> idList =
                                          provider.tempSelectedFilterEducation[
                                                  categoryData.id ?? -1] ??
                                              [];
                                      return FilterSubCheckBoxTilePartnerPreference(
                                          title:
