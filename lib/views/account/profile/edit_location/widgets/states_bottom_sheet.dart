...
class StatesBottomSheet extends StatelessWidget {
  const StatesBottomSheet({Key? key}) : super(key: key);
  ...
  Widget _optionContainer(
    ...
    return ListView.builder(
        ...
        itemBuilder: (cxt, index) {
          return InkWell(
            onTap: () {
              context.read<AccountProvider>().updateState(stateDataList[index]);
              context
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  ...
                  Selector<AccountProvider, StateData?>(
                    selector: (context, provider) => provider.stateData,
  ...
  Widget build(BuildContext context) {
    return Selector<AccountProvider, Tuple2<StateData?, CountryData?>>(
      selector: (context, provider) =>
          Tuple2(provider.stateData, provider.countryData),
