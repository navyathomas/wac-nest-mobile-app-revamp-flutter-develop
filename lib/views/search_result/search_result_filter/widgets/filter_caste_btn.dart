...
class FilterCasteBtn extends StatefulWidget {
  const FilterCasteBtn({Key? key}) : super(key: key);

  @override
  State<FilterCasteBtn> createState() => _FilterCasteBtnState();
}

class _FilterCasteBtnState extends State<FilterCasteBtn> {
        ...
        if ((casteListModel?.data?.mostUsedCaste ?? []).isNotEmpty) ...[
          SliverList(
            ...
            return FilterCheckBoxTile(
              ...
              onTap: () {
                context.read<SearchFilterProvider>().updateSelectedFilterCaste(
      ...
      child: Consumer<SearchFilterProvider>(
        builder: (context, model, child) {
          ...
          return FilterBottomSheetContainer(
            ...
            onClearTap: () =>
                context.read<SearchFilterProvider>().clearCasteTempFilterData(),
            child: BottomResView(
