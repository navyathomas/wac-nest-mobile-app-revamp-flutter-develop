...
class PremiumMembersScreen extends StatefulWidget {
  const PremiumMembersScreen({Key? key}) : super(key: key);

  @override
  State<PremiumMembersScreen> createState() => _PremiumMembersScreenState();
}

class _PremiumMembersScreenState extends State<PremiumMembersScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CommonAppBar(
        ...
        pageTitle: context.loc.premiumMembers,
      ),
      body: Consumer<PremiumMembersProvider>(
                    ...
                    return ProfileInfoListTile(
                      onTap: () => NavRoutes.navToProductDetails(
                        ...
                        arguments: ProfileDetailArguments(
                            index: index,
                            userData: userData,
                            navToProfile: NavToProfile.navFromPremiumMembers),
                      ),
                      imagePath:
  ...
  void scrollListener() {
    if (scrollController.offset >=
      ...
      context.read<PremiumMembersProvider>().onLoadMore();
    }
  }
